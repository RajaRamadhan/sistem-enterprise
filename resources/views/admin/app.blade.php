        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                        ...
                        <ul class="menu-sub">
                             <li class="menu-item">
                                <a href="{{ route('departments.index') }}" class="menu-link">
                                    <i class="menu-icon tf-icons bx bx-building" style="color: #FF6347;"></i>
                                    <div>Departemen</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('employees.index') }}" class="menu-link">
                                    <i class="menu-icon tf-icons bx bx-user-circle" style="color: #1E90FF;"></i>
                                    <div data-i18n="Sub Menu 2">Employees</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('payroll.index') }}" class="menu-link">
                                    <i class="menu-icon tf-icons bx bx-credit-card" style="color: #32CD32;"></i>
                                    <div data-i18n="Sub Menu 2">Payroll</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('leave.index') }}" class="menu-link">
                                    <i class="menu-icon tf-icons bx bx-calendar-event" style="color: #FFD700;"></i>
                                    <div data-i18n="Sub Menu 2">Leave</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('attendance.index') }}" class="menu-link">
                                    <i class="menu-icon tf-icons bx bx-time" style="color: #FF4500;"></i>
                    ...
                    <li class="menu-item">
                        <a href="#" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-lock-alt" style="color: #007bff;"></i>
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item">
                                <a href="{{ route('roles.index') }}" class="menu-link">
                                    <i class="menu-icon tf-icons bx bx-shield" style="color: #32CD32;"></i>
